...
EEE 333 Lab 5
A multi-cycle processor built in SystemVerilog. Fetches an instruction, decodes it, runs it through the ALU, and writes the result back to the register file in four states (IF, FD, EX, RWB).
...
## How to simulate
Open in ModelSim, compile Lab5.sv, then run Lab5_TB. Testbench loads instructions from Lab5.csv and prints PC, OPCODE, ALU output, and the working register each cycle to the waveform shown below.
